...
console.log('Width', sch.Width, 'Height', sch.Height, 'Length', sch.Length);
console.log('Palette type', Array.isArray(blocks.Palette) ? 'list' : typeof blocks.Palette, 'len', Array.isArray(blocks.Palette)?blocks.Palette.length:Object.keys(blocks.Palette||{}).length);
console.log('Data type', blocks.Data && blocks.Data.length, blocks.Data.constructor && blocks.Data.constructor.name);
